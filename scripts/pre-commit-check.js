...
${colors.reset}`);
  ...
  try {
    ...
    if (allPassed) {
      console.log(
        `${colors.magenta}║${colors.green}                    🎉 所有检查通过！                       ${colors.magenta}║${colors.reset}`
      );
      console.log(
        `${colors.magenta}║${colors.green}               ✨ 可以安全提交代码了 ✨                   ${colors.magenta}║${colors.reset}`
      );
      console.log(
        `${colors.magenta}╚══════════════════════════════════════════════════════════════╝${colors.reset}`
      );
      ...
      console.log(
        `${colors.magenta}║${colors.red}                    ❌ 检查失败！                           ${colors.magenta}║${colors.reset}`
      );
      console.log(
        `${colors.magenta}║${colors.red}              请修复上述问题后再提交                      ${colors.magenta}║${colors.reset}`
      );
      console.log(
        `${colors.magenta}╚══════════════════════════════════════════════════════════════╝${colors.reset}`
      );
